...
public class Upload extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   * 3. zip 압축 해제 후 lib/cos.jar 라이브러리 -> 프로젝트 webapp/WEP-INF/lib/cor.jar
	   */
	   ...
	   * 3. httpServletRequest 대신 사용할 MultipartRequest
	   */
	 ...
	 // String path = attach.getPath();   // 첨부 파일 저장 디렉터리 + 첨부 파일명
	  ...
	  String lastModified = new SimpleDateFormat("yyyy-MM-dd").format(attach.lastModified()); // 최종수정일
